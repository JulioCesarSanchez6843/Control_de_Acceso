...
// Instancia única
static BatchCapture g_batchCapture;

// Funciones públicas usadas por shim
void capture_lote_page() { g_batchCapture.handlePage(); }
void capture_lote_batchPollGET() { g_batchCapture.handleBatchPollGET(); }
void capture_lote_pausePOST() { g_batchCapture.handlePausePOST(); }
void capture_lote_removeLastPOST() { g_batchCapture.handleRemoveLastPOST(); }
void capture_lote_generateLinksPOST() { g_batchCapture.handleGenerateLinksPOST(); }
void capture_lote_finishPOST() { g_batchCapture.handleFinishPOST(); }
